  ...
  return (
    <Document>
      <Page style={styles.body}>
        ...
        <Text style={styles.heading2}>{"[[DAO LLC Name]]"} LLC</Text>
        ...
        <Text style={styles.text}>
          ...
          {"[[DAO LLC Formation Date]]"}, by and among the parties assigned
          cryptographic interests in the decentralized autonomous organization
          described on{" "}
        ...
        <Text style={styles.numbered_list}>
          ...
          <Indent />
          Effective [[DAO LLC Formation Date]], the Members form a limited
          liability company ("LLC") under the name [[DAO LLC Name]] LLC (the
          "DAO LLC") on the terms and conditions in this Operating Agreement
          (this "Agreement") and pursuant to the Delaware Limited Liability
          Company Act (6 Del. C. § 18-101 et seq.) (the "Act"). The Members
          agree to file with the appropriate agencies within the State of
          Delaware charged with processing and maintaining such records all
          documentation required for the formation and maintenance of the DAO
          LLC. The rights and obligations of the Members are as provided in the
          ...
          <Indent />
          The business of the DAO LLC will be conducted under the name [[DAO LLC
          Name]] LLC, or under such other names which the Members may agree upon
          as provided in this Agreement and from time to time.
          <Br />
          <Br />
          1.3
          <Indent />
          ...
          <Indent />
          The term of the DAO LLC commences on {
            "[[DAO LLC Formation Date]]"
          }{" "}
        ...
        <Text style={styles.numbered_list}>
          ...
          terms of this Agreement and as signified through Cryptographic
          Consensus (defined below), shall have the complete power and authority
          to manage and operate the DAO LLC and make all decisions affecting its
        ...
        <Text style={styles.numbered_list}>
          ...
          (i)
          <Indent />
          [[DAO LLC Name]] LLC has no present intention of registering the
          Cryptographic Units and is under no obligation to register the
          Cryptographic Units. There is no assurance that any exemption from
          registration under the Securities Act will be available, and that,
          even if available, such exemption may not allow Members to transfer
          all or any portion of the Cryptographic Units under the circumstances,
          in the amounts, or at the times that they might propose;
          <Br />
          <Br />
          (ii)
          <Indent />
        ...
        <Text style={styles.text}>0x{"[[DAO LLC Organizer EthAddress]]"}</Text>
        <Text
      ...
      <Page style={styles.body}>
        ...
        <Text style={styles.text}>FOR {"[[DAO LLC Name]]"} LLC</Text>
        <Text style={styles.text}>
